...
export default function Hero() {
  ...
  return (
    <section className="min-h-screen flex flex-col md:flex-row bg-black text-[var(--theme-text)]">
      ...
      <div className="flex flex-col justify-center items-center text-center px-6 py-10 md:flex-1 md:px-12 lg:px-16">
        ...
        >
          <span className="text-[var(--theme-text)]">More Time </span> for
          Shine, <span className="text-[var(--theme-text)]">Less Time </span> on
          Paperwork.
        </motion.h1>
        ...
        >
          Run your detailing biz smoother than a freshly waxed hood.
        </motion.p>
      </div>
